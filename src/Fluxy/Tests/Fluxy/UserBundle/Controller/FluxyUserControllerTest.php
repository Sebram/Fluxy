...
namespace App\Fluxy\Tests\Fluxy\UserBundle\Controller;

use App\Fluxy\UserBundle\Controller;
use PHPUnit\Framework\TestCase;


class FluxyUserControllerTest extends TestCase
{
    ...
    public function homeAction()
    {
        ...
        $this->assertEquals('Fluxy', $appname);
    }
    ...
    public function newUsersAction(Request $request)
    {
        ...
        $this->assertEquals('curl oauth token ok', $succesfullyRegistered);
    }
